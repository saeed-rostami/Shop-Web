...
@section('Content')
    <div class="text-muted row justify-content-end">
        <div class="col-12 col-md-6 rounded black-bg">
            <h5> نام : {{$user->name}}<img style="width: 40px; height: 40px" src="{{asset('images/test-account.png')}}" alt=""></h5>
            <h5> نام خانوادگی : {{$user->family}}<img style="width: 40px; height: 40px" src="{{asset('images/family.png')}}" alt=""></h5>
